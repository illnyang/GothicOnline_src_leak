...
public:
	...
	* @usable Ingame only
	*/
	void RenderItem(zINT p1, zINT p2) //exists in g1 with other params
	{
		XCALL(0x007133C0);
	};
	...
	* @usable Ingame only
	*/
	zINT RenderItem(zINT p1, zINT p2, zFLOAT p3) //does not exists in g1
	{
		XCALL(0x00713AC0);
	};
	...
	* @usable Ingame only
	*/
	void RenderItemPlaceCamera(zINT p1, zFLOAT p2) //Exitsts in g1 with other params
	{
		XCALL(0x00713800);
	};
	...
	* @usable Ingame only
	*/
	void RotateForInventory(zINT p1)
	{
		XCALL(0x00672560);
	};
